    ...
    if mode in ["predict", "all"]:
        ...
        for model_name in model_names:
            ...
            try:
                ...
                # ✅ Handle probabilistic predictions (multi-column)
                if isinstance(predictions, pd.DataFrame):
                    for col in predictions.columns:
                        results_df[f"{model_name}_{col}"] = predictions[col]
                else:
                ...
                if has_target:
                    try:
                        ...
                        logger.warning(f"Metrics skipped for {model_name} due to error: {eval_error}")
